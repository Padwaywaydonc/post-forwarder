...
* **X (Twitter)** — posts the title and post URL as a tweet; featured image attaches directly on paid API tiers or appears as a link preview card on public sites. Authorized via OAuth 2.0 through the relay server. Each user needs a free X developer account.
